...
def create_queries(out_dir, all_facts, templates, qid_names, qid_numfacts,
    ...
    save_dir = os.path.join(templama_docker_dir, 'dataset_from_{}-{}-{}_to_{}-{}-{}_per_{}_again'.format(min_year,
                                                                                                   min_month,
                                                                                                   min_day,
                                                                                                   max_year,
                                                                                                   max_month,
...
def main(_):
    ...
    create_queries(out_dir, all_facts, templates, qid_names, qid_numfacts,
